...
sim1 = matchsim.matchsim(simteams=["Sri Lanka", "Australia"])
...
statsmatchtype = "T20" # Options: ["Test","ODI", "ODM", "T20",] Explanation of what these mean is found at https://cricsheet.org/downloads/
simulations=10 # This is the number of simulations to run

# Optional Arguments:

inningsorder = None # Eg. ["Sri Lanka", "Australia","Sri Lanka", "Australia"] for a test match # This overrides the toss rng and sets a specific innings order.
rain=False # This sets whether there might be rain affected matches in the simulated games.

# Apply sim() method on the simulation object.
sim1.sim(statsdatabase=statsdatabase, statsfrom_date=statsfrom_date,statsto_date=statsto_date, statssex=statssex,statsmatchtype=statsmatchtype,simulations=simulations, inningsorder=inningsorder, rain=rain)
